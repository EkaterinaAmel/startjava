public class VariablesTheme {
    public static void main(String[] args) {
        ...
        longMaxDecrement--;
        System.out.print("значение после декремента long = " + longMaxDecrement);
        ...
        System.out.println("Исходные значения переменных: первая переменная = " + number1 + ", вторая переменная = " + number2);
        number1 = number2;
        number2 = temp;
        System.out.println("Новые значения переменных: первая переменная = " + number1 + ", вторая переменная = " + number2);
        ...
        number1 ^= temp;
        number2 ^= temp;
        System.out.print("Новые значения переменных: первая переменная = " + number1 + ", вторая переменная = " + number2);
